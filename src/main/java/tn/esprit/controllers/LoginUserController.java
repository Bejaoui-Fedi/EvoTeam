...
public class LoginUserController {
    ...
    private void handleLogin() {
        ...
        try {
            ...
            if ("ADMIN".equals(user.getRole())) {
                showMessage("❌ Accès refusé ! Utilisez l'espace administrateur.", "error");
                return;
            }
            ...
            stage.setTitle("Evolia - Mon espace");
    ...
    private void handleRegisterLink() {
        try {
            ...
            stage.setTitle("Evolia - Inscription");
            stage.centerOnScreen();
            stage.show();
    ...
    private void handleForgotPassword() {
        ...
        alert.setContentText("Veuillez contacter l'administrateur à admin@evolia.com");
        alert.showAndWait();
    }
