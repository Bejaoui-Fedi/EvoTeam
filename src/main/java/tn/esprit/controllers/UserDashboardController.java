...
public class UserDashboardController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        System.out.println("UserDashboardController initialise");
        resetButtonStyles();
    ...
    // =====================================================
    // METHODE PUBLIQUE pour que les sous-controllers puissent
    // charger du contenu dans le contentArea (sidebar reste visible)
    // =====================================================
    ...
    public void setCurrentUser(User user) {
        if (user == null) {
            System.err.println("Tentative de setCurrentUser avec null");
            return;
        }
        this.currentUser = user;
        updateUserInfo();
        System.out.println("Utilisateur connecte: " + user.getNom() + " (" + user.getRole() + ")");
    }
    ...
    // =====================================================
    // EVENEMENTS - Charge UserDisplayEvent dans le contentArea
    // L'utilisateur voit les events en LECTURE SEULE
    // mais peut naviguer vers les reviews (CRUD complet)
    // =====================================================
    @FXML
    private void handleEvents() {
        ...
        try {
            ...
            // Passer la reference du dashboard au controller
    ...
    private void handleWellness() {
        System.out.println("Navigation vers Journal bien-etre");
        resetButtonStyles();
        setActiveButton(btnWellness);
        showPlaceholder("Journal bien-etre");
    }
    ...
    private void handleProfile() {
        ...
        try {
            ...
            showError("Page de profil non trouvee");
        }
    }
    ...
    private void handleLogout() {
        ...
        try {
            ...
            stage.show();
            System.out.println("Redirection vers LoginView reussie");

        } catch (IOException e) {
            System.err.println("Erreur chargement LoginView.fxml: " + e.getMessage());
            showError("Page de connexion non trouvee");
        }
    }
