...
public class AdminSupervisionConsultationController {
    ...
    public void setDashboardController(AdminDashboardController dashboardController) {
        ...
        System.out.println("✅ Dashboard controller reçu dans AdminSupervisionConsultationController");
    }
    ...
    private void retourSupervisionRdv() {
        try {
            if (dashboardController != null) {
                // Utiliser le dashboard pour charger la vue des rendez-vous
                ...
                AdminSupervisionRdvController controller = loader.getController();
                controller.setDashboardController(dashboardController);

                // Remplacer le contenu dans le dashboard
                dashboardController.getContentArea().getChildren().clear();
                dashboardController.getContentArea().getChildren().add(rdvView);
