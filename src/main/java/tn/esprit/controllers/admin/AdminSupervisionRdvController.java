...
public class AdminSupervisionRdvController {
    ...
    // Setter pour recevoir le dashboard controller
    public void setDashboardController(AdminDashboardController dashboardController) {
        this.dashboardController = dashboardController;
        System.out.println("✅ Dashboard controller reçu dans AdminSupervisionRdvController");
    }
    ...
    private void gererConsultations() {
        try {
            if (dashboardController != null) {
                // Utiliser le dashboard pour charger la vue des consultations
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/admin/admin_supervision_consultation.fxml"));
                Parent consultationView = loader.load();

                // Passer la référence du dashboard au controller des consultations
                AdminSupervisionConsultationController controller = loader.getController();
                controller.setDashboardController(dashboardController);

                // Remplacer le contenu dans le dashboard
                dashboardController.getContentArea().getChildren().clear();
                dashboardController.getContentArea().getChildren().add(consultationView);

                System.out.println("✅ Navigation vers consultations via dashboard");
            } else {
