...
public class ProGestionRdvController {
    ...
    public void setDashboardController(UserDashboardController dashboardController) {
        ...
        System.out.println("✅ Dashboard controller reçu dans ProGestionRdvController");
    }
    ...
    private void gererConsultations() {
        if (dashboardController != null) {
            // Utiliser le dashboard pour naviguer vers les consultations
            dashboardController.navigateToConsultations();
        } else {
