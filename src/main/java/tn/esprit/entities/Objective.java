...
public class Objective {
    ...
    public Objective(Long idObjective, String title, String description,
    ...
    public Objective(String title, String description, String level, int isPublished) {
        this.title = title;
        this.description = description;
        this.level = level;
        this.isPublished = isPublished;
    ...
    public Objective(int userId, String title, String description, String level, int isPublished) {
        this.userId = userId;
        this.title = title;
        this.description = description;
        this.level = level;
    ...
    public Objective(Long idObjective, int userId, String title, String description,
            String level, int isPublished) {
        this.idObjective = idObjective;
        this.userId = userId;
        this.title = title;
